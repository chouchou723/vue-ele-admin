<template>
  <div>
    ...
    <div
      id="tableTotal"
      style="width: 100%;height:100%;background: white;position:relative;border-radius:5px;margin-bottom:10px;"
    >
      <div
        class="newResourceAn"
        style="position:relative;padding:10px;margin-bottom:10px;height:55px;border-bottom:1px solid gainsboro;background:#fafafa"
      >
      ...
      <IEcharts :option="line" style="height:400px;margin-bottom:10px;" />
      <IEcharts :option="line1" style="height:400px;margin-bottom:10px;" />
...
export default {
  ...
  methods: {
    ...
    getCM1Data(date) { // 折线图
      const para = {
        currentTime: date || this.currentTime
        // school_id:this.valueCM8
